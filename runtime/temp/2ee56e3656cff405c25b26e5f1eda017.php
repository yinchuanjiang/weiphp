<?php /*a:1:{s:54:"/www/wwwroot/weiphp/application/h5/view/index/psd.html";i:1558359959;}*/ ?>
<!DOCTYPE html>
...
<div id="app1">
    <div class="_vp_page vp-psd1 app-view" style="background: rgb(35, 24, 21);">
        <div class="_vp_layer vp-image-m1_7" style="width: 17.9688rem; height: 0.03125rem; left: 1.03125rem; top: 5.15625rem;">
            <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAj8AAAABCAYAAAAxQ8/DAAAAAklEQVR4AewaftIAAAAfSURBVGP5c4LhAAMDgz3DKBgFo2AUjIJRMApGwQgAAPmMAshb9alVAAAAAElFTkSuQmCC">
        </div>
        <div class="_vp_layer vp-image-m1_6" style="width: 90%; height: 8%; left: 5%; top: 18%">
            <img src="/static/vp-image-m1_6.png">
        </div>
        <div class="_vp_layer vp-image-m1_5" style="width: 90%; height: 26%; left: 5%; top: 61%">
            <img src="data:image/png;base64,">
        </div>
        <div class="_vp_layer vp-image-m1_4" style="width: 90%; height: 26%; left: 5%; top: 30%">
        </div>
        <div class="_vp_layer vp-image-m1_3" style="width: 80%; height: 26%; left: 10%; top: 63%;">
            <img src="/static/gif0.gif"></div>
        <div class="_vp_layer vp-image-title" style="width: 90%; height: 9%; left: 5%; top: 5%">
            <img src="/static/title.png">
        </div>
        <div class="_vp_layer vp-image-c1" style="width: 80%; height: 20%; left: 10%; top: 32%;">
            <img src="/static/gif1.gif">
        </div>
        <div class="_vp_layer vp-image-h1" style="width: 90%; height: 3%; left: 28%; top: 49%;">
            <h3>六安市银发微笑摄影大赛</h3>
        </div>
        <div class="_vp_layer vp-image-h2" style="width: 90%; height: 3%; left: 26%; top: 80%;">
            <h3>六安市银发微笑代言人选举</h3>
        </div>
...
<script>
    $(function () {
        $('.vp-image-title').on('click', function () {
            location.href = '/h5/index/about.html';
        })
        $('.click-here').on('click',function () {
            location.href = '/h5/index/index.html';
        })
    })
</script>
</body>
