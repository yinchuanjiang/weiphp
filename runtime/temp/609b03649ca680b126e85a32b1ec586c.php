<?php /*a:2:{s:56:"/www/wwwroot/weiphp/application/admin/view/menu/add.html";i:1558430650;s:60:"/www/wwwroot/weiphp/application/admin/view/publics/base.html";i:1558430650;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8" />
              ...
              <label class="item-label">
                ...
                <?php if(!(empty($field['remark']) || (($field['remark'] instanceof \think\Collection || $field['remark'] instanceof \think\Paginator ) && $field['remark']->isEmpty()))): ?>（<?php echo $field['remark']; ?>）<?php endif; ?>
                  ...
                  <?php break; case "string": ?>
                    ...
                    <input type="datetime" name="<?php echo htmlentities($field['name']); ?>" class="text input-large time" value="<?php echo I($field['name'], $field['value']); ?>" placeholder="请选择时间" />
                  <?php break; case "date": ?>
                    <input type="datetime" name="<?php echo htmlentities($field['name']); ?>" class="text input-large date" value="<?php echo I($field['name'], $field['value']); ?>" placeholder="请选择日期" />
                  <?php break; case "bool": ?>
