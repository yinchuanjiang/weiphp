  ...
  <div class="tab-content"> 
    ...
    <form class="form-horizontal bind_step_form" method="post" action="<?php echo U('weixin/Publics/step_0'); ?>" id="form" style="overflow:hidden; zoom:1">
      ...
      <div class="tab-pane in tab1" id="tab1">
        ...
        <div class="form-group row cf toggle-wechat">
          <label class="col-sm-2"> <span class="need_flag">*</span> 微信号 </label>
          <div class="col-sm-8">
            <input type="text" value="<?php echo htmlentities($info['wechat']); ?>" name="wechat" class="text input-large">
          </div>
        </div>           
        </div>     
