          ...
          <ul id="tab" class="tab-pane in" style="width: 90%;min-height: 500px;box-shadow: 1px 1px 5px rgba(0, 0, 0, 0.36);margin: 3% 5%;padding:3% 0 5%;border-radius:5px">
              ...
              <table width="80%" style="margin-left: 10%;border-collapse:separate; border-spacing:0;">
                  <tr>
                      ...
                      <td class="left"><font>关注时长</font></td>
                      <td class="right right-right" style="border-top: 1px solid rgba(51, 118, 181,0.3);"><?php echo htmlentities($info['reg_time']); ?></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                      ...
                      <td class="right right-right"><?php echo htmlentities($info['remark']); ?></td>
                  </tr>
                  <tr>
                      <td class="left"><font>登录次数</font></font></td>
                      <td class="right"><?php echo htmlentities($info['login_count']); ?></td>
                  ...
                  <tr>
                      ...
                      <td class="right right-right"><?php echo htmlentities($info['truename']); ?></td>
                  </tr>
                  <tr>
                      ...
                      <td class="right right-right"><?php echo htmlentities($info['mobile']); ?></td>
                  </tr>
                  <tr>
