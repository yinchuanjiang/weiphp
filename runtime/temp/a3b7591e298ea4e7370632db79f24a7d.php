<?php /*a:2:{s:57:"/www/wwwroot/weiphp/application/admin/view/menu/edit.html";i:1558430650;s:60:"/www/wwwroot/weiphp/application/admin/view/publics/base.html";i:1558430650;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8" />
                  ...
                  <div class="form-item cf toggle-<?php echo htmlentities($field['name']); ?>">
                    ...
                    <div class="controls">
                        <?php switch($field['type']): case "num": ?>
                          ...
                          <input type="datetime" name="<?php echo htmlentities($field['name']); ?>" class="text input-large time" value="<?php echo htmlentities(time_format($data[$field['name']])); ?>" placeholder="请选择时间" />
                        <?php break; case "date": ?>
                          <input type="datetime" name="<?php echo htmlentities($field['name']); ?>" class="text input-large date" value="<?php echo htmlentities(time_format($data[$field['name']],'Y-m-d')); ?>" placeholder="请选择时间" />
                        <?php break; case "bool": ?>
...
<?php if(config('COLOR_STYLE')=='blue_color') echo '<link href="/static/datetimepicker/css/datetimepicker_blue.css?v=<?php echo SITE_VERSION; ?>" rel="stylesheet" type="text/css">'; ?>
