            ...
            <form id="form" action="<?php echo htmlentities($post_url); ?>" method="post" class="form-horizontal form-center">
                ...
                <div class="form-group row cf toggle-<?php echo htmlentities($field['name']); ?>">
                    ...
                    <div class="col-sm-8">
                        ...
                        <input type="datetime" name="<?php echo htmlentities($field['name']); ?>" class="text time" value="<?php echo I($field['name'], $field['value']); ?>" placeholder="请选择时间" /> <?php break; case "date": ?>
...
<!--                             <input type="hidden" name="<?php echo htmlentities($field['name']); ?>" value="" /> -->
                            <div class="upload-img-box">
                            </div>
                        </div>
                        <?php break; case "user": ?>
