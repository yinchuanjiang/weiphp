<?php /*a:1:{s:57:"/www/wwwroot/weiphp/application/h5/view/index/upload.html";i:1558349091;}*/ ?>
<!DOCTYPE html>
...
<div id="app1">
    <div class="uploader-page app-view">
        <div class="editor">
            <div data-width="0" class="comp-cropper"><!---->
                <div class="upload-icon"><i class="iconfont icon-zhongxinshangchuan"></i></div>
                <div class="preload-hidden">
                    <canvas width="0" height="0"></canvas>
                    <img src="/static/poster.png" class="hidden">
                    <input type="file" name="uplaod" accept="image/*" style="display: block; width: 0px; height: 0px;">
                </div>
                <div class="tips" style="display: none;"><span></span></div>
                <div class="tools">
                    <div data-v-0dcfc57a="" title="拍照" class="icon-btn">
                        <div data-v-0dcfc57a="" class="icon"><i data-v-0dcfc57a="" class="iconfont icon-paizhao2"></i>
                        </div>
                        <div data-v-0dcfc57a="" class="text">拍照</div>
                    </div>
                    <div data-v-0dcfc57a="" title="作品墙" class="icon-btn">
                        <div data-v-0dcfc57a="" class="icon"><i data-v-0dcfc57a="" class="iconfont icon-tupian"></i>
                        </div>
                        <div data-v-0dcfc57a="" class="text">作品墙</div>
                    </div>
                    <div data-v-0dcfc57a="" title="规则" class="icon-btn">
                        <div data-v-0dcfc57a="" class="icon"><i data-v-0dcfc57a="" class="iconfont icon-guize1"></i>
                        </div>
                        <div data-v-0dcfc57a="" class="text">规则</div>
                    </div>
                </div>
            </div>
            <img src="/static/masker.png" class="masker"></div>
        <div class="modal-mask preview-modal size-mini" style="display: none;">
            <div class="modal-wrapper">
                <div class="modal-container">
                    ...
                    <div class="modal-body"><img src="" class="preview-src"></div>
        ...
        <div class="modal-wrapper">
            <div class="modal-container">
                ...
                <div class="modal-body">
                    <div class="rule-preview" style="max-height: 441.6px;"><img src="/static/rule.png"></div>
                </div>
                <div class="modal-footer"></div>
            </div>
        </div>
...
<script>
    $(function () {
        ...
        //拍照
        $('.icon-paizhao2').on('click',function () {
            $('input[name="uplaod"]').click();
        })
        //照片上传
        $('input[name="uplaod"]').change(function () {
            var formdata = new FormData();
            formdata.append("upload", $('input[name="uplaod"]')[0].files[0]);
            formdata.append("openid",'xxxsssasasdaadadada');
            $.ajax({
                type: "POST",
                url: "https://lets.gaojb.com/h5/upload/upload",
                data: formdata,
                ...
                success: function(data) {
                    if(data.code == '200'){
                        layer.msg('上传成功');
                        setTimeout(function () {
                            location.href = '/h5/index/index?type=my'
                        },1000)
                    }else {
                        layer.msg('系统错误');
                    }
